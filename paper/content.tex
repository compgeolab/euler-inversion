...
\caption{
  \lipsum[1]. The geologic map in a) was modified from \citet{Heilbron2016}.
}
\label{fig:map}
\end{figure}
...
and grant 2021/08379-5 from the Fundação de Amparo à Pesquisa do Estado de São Paulo (FAPESP). 

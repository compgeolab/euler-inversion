...
The Euler deconvolution method was created to solve this issue, particularly for idealized sources (such as spheres \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend planar vertical dykes).

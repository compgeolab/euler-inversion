...
\usepackage{environ}
% To control hyphenation for individual blocks of text \usepackage{hyphenat}
...
\begin{FlushLeft}
  ...
  \newline
  {\footnotesize
    Submitted as a preprint to EarthArXiv on \PreprintOn.
    Published in final form after peer-review on \PublishedOn.
  }
\end{FlushLeft}
...
\begin{summarybox}
  ...
  You can find it at doi:\href{https://doi.org/\ArchiveDOI}{\ArchiveDOI},
  Software Heritage: \href{\SWHeritageURL}{\SWHeritageID},
  and GitHub: \href{https://github.com/\GitHubRepository}{\GitHubRepository}.
  \\[0.2cm]
  \noindent
